...
insert into vehicles (id, plate, brand, model, accessories) values
  (gen_random_uuid(), 'AB123CD', 'Mercedes-Benz', 'Sprinter', ''),
  (gen_random_uuid(), 'AC456EF', 'Iveco', 'Daily', ''),
  (gen_random_uuid(), 'AD789GH', 'Ford', 'Cargo 1723', 'faja,traca'),
  (gen_random_uuid(), 'AE234JK', 'Toyota', 'Hilux', ''),
  (gen_random_uuid(), 'AF567LM', 'Scania', 'R450', 'grua,rampa');

select id, plate, brand, model, accessories from vehicles;
